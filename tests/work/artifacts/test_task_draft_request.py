...
class TaskDraftRequestTests(FileInputTestCase):
    ...
    def test_cli_uses_saved_selection_without_flags(self):
        ...
        code = main(self.input_arguments([
            "--project-root", str(self.root), "task", "draft-save-request", "--input-file", "request.json",
        ...
        self.assertEqual(json.loads(output.getvalue())["data"]["revision"], 3)
    ...
    def test_cli_saves_small_payload_end_to_end(self):
        ...
        self.assertEqual((code, error.getvalue()), (ExitCode.SUCCESS, ""))
        self.assertEqual(json.loads(output.getvalue())["data"]["revision"], 2)
