...
Apply this section only when confirmed discussion requires revision of existing formal Plan, TASK and execution-index artifacts together. Initial artifact creation, Task checkpoint approval and source updates, skill selection, normal cross-session handoffs and execution authorization retain their own workflows. A checkpoint is not a formal TASK.
