...
4. Place the rendered JSON in one conversation code block without edits. A handoff exists only in the conversation and never modifies Plan, TASK, index, Attempt, or lock state.
