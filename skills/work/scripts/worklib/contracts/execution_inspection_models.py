...
class ExecutePreflightContract(WorkContract):
    ...
    canonical_order: ClassVar[tuple[str, ...]] = (
        "schema", "requirement_id", "task_spec_id", "task_id", "skill_id",
        "task_path", "execution_dir", "index_path", "task_status", "dependencies",
        "confirmed_inputs", "inputs", "files", "task_collection_sha256",
        "task_index_sha256", "task_item_sha256", "hierarchy_selection_sha256",
        "task_instructions_sha256", "execute_instructions_sha256",
        "execute_instruction_selection", "execute_skill_selection", "index_sha256",
        "eligibility",
    )
...
class ExecuteWorktreeContract(WorkContract):
    ...
    contract_kind: ClassVar[Literal["response"]] = "response"
    canonical_order: ClassVar[tuple[str, ...]] = (
        "schema", "requirement_id", "task_spec_id", "task_id",
        "task_collection_sha256", "task_index_sha256", "task_item_sha256",
        "task_instructions_sha256", "execute_instructions_sha256", "task_status",
        "task_path", "index_sha256", "execution_dir", "snapshot_sha256",
        "review_status", "excluded_execution_change_count", "counts", "changes",
    )
