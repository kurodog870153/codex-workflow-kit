...
from ...services.task.draft.storage import read_task_draft_from_index, read_task_planning_index
from ...models.task_draft import TaskDraftSourceCheckContract
...
def check_task_draft_sources(
    ...
    *,
    ...
    normalized, resolved, raw = read_project_task_source(project_root, plan_path, field="plan_path")
    ...
    selection = operations.build_instruction_selection(
