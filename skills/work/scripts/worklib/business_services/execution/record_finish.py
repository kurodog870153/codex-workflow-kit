...
from ...models.execution.record import RecordFinishContract
from ...services.record.validation import parse_record_finish_request
from ...services.record.result import finish_attempt_candidate
...
def build_finished_attempt(
    ...
    *,
    ...
    candidate = finish_attempt_candidate(
        attempt, request, expected_record_id=expected_record_id,
        expected_kind=expected_kind, command_correction=command_correction,
    )
...
def finish_record(
    ...
    *,
    ...
    request = parse_record_finish_request(
...
from ...services.authorization.rules import require_modified_files, require_result_evidence
