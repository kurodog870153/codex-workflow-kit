...
from ...models.execution.record import RecordBeginContract
...
from ...services.execution.lifecycle import parse_json_contract, resolve_project_relative_path
...
def begin_record(
    *,
    ...
    validate_execute_instructions(task, attempt, operation="record_begin", operations=operations)
...
from ...services.authorization.rules import require_record_scope, require_retry_evidence
