...
from ...services.recovery.validation import parse_execution_recovery_prepare_request
from ...services.correction.document import canonicalize_correction_contract, render_correction_contract
from ...models.common.errors import ExitCode, WorkError
from ...services.execution.recovery import raw_sha256, read_raw, parse_json_contract, normalize_relative_path
from ...services.specification.transaction import require_no_spec_update
from ...services.execution.recovery import storage_path, require_idle_writer
...
def prepare_execution_recovery(raw, *, source, project_root: Path, user_config_root: str,
    ...
    value = parse_execution_recovery_prepare_request(
        raw, source=source
    )
