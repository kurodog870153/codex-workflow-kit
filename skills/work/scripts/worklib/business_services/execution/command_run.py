...
from ...services.command.validation import parse_command_run_request
from ...models.common.errors import ExitCode, WorkError
from ...services.execution.command import raw_sha256, read_raw, normalize_relative_path
from ...services.specification.transaction import require_no_spec_update
from ...services.execution.command import storage_path, require_idle_writer, state_writer, write_command_receipt, execute_command as _execute
...
def _prepare(raw, *, source, project_root, user_config_root, raw_task_path, raw_execution_dir, task_id, skill_roots=None, include_authorization=False, operations=None):
