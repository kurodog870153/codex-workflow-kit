...
from ...models.execution.inspection import ExecutePreflightContract
from ...models.common.errors import ExitCode, WorkError
from ...services.attempt.validation import validate_execution_index
from ...services.execution.preflight import (
    parse_json_contract,
...
from ...services.preflight.validation import require_index_identity
...
def execute_preflight(
    *,
    ...
    execute_selection = operations.build_instruction_selection(
