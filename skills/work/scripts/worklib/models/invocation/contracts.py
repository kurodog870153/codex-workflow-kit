...
InvocationEntry = Annotated[WorkflowEntry | ProgressResumeEntry | TaskPlanningEntry, Field(discriminator="kind")]
...
class InvocationContract(WorkContract):
    ...
    contract_example: ClassVar[dict[str, object]] = {
        ...
        "request": "Describe the requested change.", "entry": {"kind": "workflow"},
    }
