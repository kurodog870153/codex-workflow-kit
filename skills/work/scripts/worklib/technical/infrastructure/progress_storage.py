...
from .specification_storage import storage_path
...
def _write_progress_bytes(path: Path, raw: bytes) -> None:
...
def _replace_progress_file(source: Path, destination: Path) -> None:
