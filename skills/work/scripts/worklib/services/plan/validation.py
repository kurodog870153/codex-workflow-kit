...
from ...technical.infrastructure.work_paths import validate_artifact_paths
from ...models.common.errors import ExitCode, WorkError
from ...models.plan import ID_PREFIXES, TOP_OPTIONAL, TOP_REQUIRED, PlanContract
...
def _strict_keys(value: object, *, location: str, required: set[str], optional: set[str] | None = None) -> dict[str, Any]:
...
def validate_plan_contract(
    ...
    *,
    ...
    project_root: Path,
    hierarchy_selection: dict[str, object],
    ...
    return {
        ...
        "skill_selection_sha256": skill_selection_sha256,
...
__all__ = ["validate_plan_contract"]


def render_plan_contract(contract: dict[str, Any]) -> bytes:
    """Render a validated Plan model with canonical field order."""
    try:
        checked = PlanContract.model_validate(contract).to_canonical_dict()
    except ValidationError as error:
        raise PlanContract._work_error(error) from error
    return render_json_contract(checked)
