...
from ....technical.infrastructure.text_codec import canonical_sha256, decode_utf8
from ....technical.infrastructure.json_contract import parse_json_contract
from ....technical.infrastructure.work_paths import resolve_project_relative_path, validate_artifact_paths
...
from ....models.task_collection import TaskCollectionDiagnosticsContract
...
def _execution_state(
    report, project_root, execution_dir, *, validate_execution_index,
    validate_attempt_json_contract, index_raw=None, ignored_record=None,
):
...
def diagnose_task_collection(
    ...
    *,
    ...
    validate_task_collection_contract,
    ...
    from ....technical.infrastructure.work_paths import resolve_task_collection_item_path
