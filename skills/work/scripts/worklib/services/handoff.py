...
from .skill_selection import selection_sha256
...
from ..execution.preflight import require_index_identity
...
def verify_return_handoff(
    ...
    options = dict(task_path=normalized_task, task_id=task_id,
                   user_config_root=user_config_root, skill_roots=skill_roots)
