...
from ..contracts.task_repair_models import (
    TaskRepairContract,
...
from .specification import execution_history_fingerprints, rebuild_execution_index
    ...
    *,
    ...
    prepared = {
        **copy.deepcopy(value),
        ...
        "expected": {
            path: raw_sha256(source[path]) if path in source else None
            for path in paths
        },
    }
